        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Articles_ServiceOrders_ServiceOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TechniciansIds = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dispatchers_ServiceOrders_ServiceOrderId",
                        column: x => x.ServiceOrderId,
                        principalTable: "ServiceOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "845792ea-8e0a-4fd8-bdbb-0af06a332708", null, "User", "USER" },
                    { "b6eb68f9-fef7-483a-9af9-06b8f51e0a06", null, "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Articles_ServiceOrderId",
                table: "Articles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dispatchers_ServiceOrderId",
                table: "Dispatchers",
                column: "ServiceOrderId");
